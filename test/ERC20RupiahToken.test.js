...
contract("ERC20RinggitToken", function([
  deployer,
  initialHolder,
  recipient,
  anotherAccount
    ...
    describe("when the recipient is not the zero address", function() {
      ...
      describe("when the spender has enough approved balance", function() {
        ...
        describe("when the initial holder has enough balance", function() {
          ...
          it("transfers the requested amount", async function() {
            await this.token.transferFrom(initialHolder, to, amount, {
              from: spender
            });
        ...
        describe("when the initial holder does not have enough balance", function() {
          ...
          it("reverts", async function() {
            await shouldFail.reverting(
              this.token.transferFrom(initialHolder, to, amount, {
                from: spender
              })
            );
          });
  ...
  describe("burn", function() {
    describe("for a non null account", function() {
      it("rejects burning more than balance", async function() {
        await this.token.transfer(deployer, initialSupply, {
          from: initialHolder
        });
      ...
      const describeBurn = function(description, amount) {
        describe(description, function() {
          beforeEach("send to contract owner, then burn", async function() {
            await this.token.transfer(deployer, amount, {
              from: initialHolder
            });
